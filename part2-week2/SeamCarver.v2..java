 ...
 *  
 *  TODO Optimization:  
 *  1. Note:  fixed the slow performance issue due to the bottleneck of creating Color objects. workaround is transpose the Picture object to int[][] in construct function, so that reduce the use of Picture.get() function. 
 *  2. Try to use other shortest path algorithm. eg. Dijkstra
 *    
 *  Reference:
